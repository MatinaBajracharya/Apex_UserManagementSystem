			...
			<div class="info">
					<div class="container" style="margin-top: -25px; margin-left: -25px;">
						<div class="row">
							...
							<form action="/usermgmt/app/submit" style="margin-left:150px;" method="post" onsubmit="return Validate()" name="vform">
							<div class="col-md-8 float-left">
								<div class="card info">
								<h3 style="color:red; text-align:center; margin-top:5px;">${pwMsg}</h3>
									<div class="card-body">
										...
										<div class="form-group">
											...
											<input type="radio" id="client" name="role" value="CLIENT" checked="checked">
							...
							<div class="col-md-4 float-right">
								<div class="card info" style="width: 35rem;">
									<div class="card-body">
